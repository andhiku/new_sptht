...
<!-- <section class="login_content">
              ...
              <div>
                <label for="umur"class="sr-only">Masukkan Umur></label>
                <input type="umur" id="umur" name="umur" class="form-control" placeholder="Umur" required />
              </div>
              <div>
                <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit">Regist</button>
